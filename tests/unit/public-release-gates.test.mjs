...
describe('public release gates', () => {
  ...
  it('rejects broken links and forbidden runtime hosts', () => {
    const distDir = mkdtempSync(join(tmpdir(), 'why-models-learn-dist-'));
    writeFileSync(
      join(distDir, 'index.html'),
      '<a href="/why-models-learn/missing/">missing</a><script src="https://www.googletagmanager.com/gtag/js"></script>',
    );
    const result = checkStaticSite({ distDir, siteBase: '/why-models-learn' });
  ...
  it('accepts resolvable project-base pages and assets', () => {
    ...
    writeFileSync(join(distDir, 'index.html'), '<a href="/why-models-learn/about/">about</a><link rel="stylesheet" href="/why-models-learn/_astro/site.css">');
    writeFileSync(join(distDir, 'about', 'index.html'), '<a href="/why-models-learn/">home</a>');
